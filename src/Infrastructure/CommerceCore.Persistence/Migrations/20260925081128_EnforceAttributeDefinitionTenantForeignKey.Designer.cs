...
namespace CommerceCore.Persistence.Migrations
{
    ...
    [Migration("20260925081128_EnforceAttributeDefinitionTenantForeignKey")]
    partial class EnforceAttributeDefinitionTenantForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CommerceCore.Domain.Catalog.Products.ProductVariant", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ProductId", "Id")
            ...
            modelBuilder.Entity("CommerceCore.Platform.ControlPlane.Entities.Storefront", b =>
                {
                    ...
                    b.ToTable("storefronts", "platform", t =>
                        {
                            t.HasCheckConstraint("ck_platform_storefronts_host_name_lowercase", "host_name = lower(host_name)");
                        });
                });
            ...
            modelBuilder.Entity("CommerceCore.Platform.ControlPlane.Entities.Tenant", b =>
                {
                    ...
                    b.ToTable("tenants", "platform", t =>
                        {
                            t.HasCheckConstraint("ck_platform_tenants_status", "status IN ('Active', 'Inactive')");
                        });
                });
            ...
            modelBuilder.Entity("CommerceCore.Platform.ControlPlane.Entities.TenantMembership", b =>
                {
                    ...
                    b.ToTable("tenant_memberships", "platform", t =>
                        {
                            t.HasCheckConstraint("ck_platform_tenant_memberships_status", "status IN ('Active', 'Inactive')");
                        });
                });
